...
export default class ColorUI extends Plugin {
	...
	init() {
		...
		editor.ui.componentFactory.add( this.componentName, locale => {
			...
			var ui = new ReactView(locale, <ColorPicker ref={color => this.colorPicker = color} onChange={(value)=>{ 
				editor.execute( this.commandName, {value} );
				editor.editing.view.focus();
			}}></ColorPicker>);

			dropdownView.buttonView.on('execute', () => {
				this.colorPicker.setValue(command.value);
			})
