	...
	render(){
		...
		return(
				<div className="dropdown">
				  <div className="filter_item_input" data-toggle="dropdown" aria-haspopup="true" style={{cursor:'pointer'}} {...this.rent}>
				  	&nbsp;{Object.keys(this.state.value).map((e)=>{if( e != '' && this.state.value[e]){return this.options[e]} }).filter((e)=>{return e}).join(', ')}
				  </div>
				  <div className="dropdown-menu" style={{padding:5, maxHeight: 300, overflow: 'auto'}}>
				  	{this.drawOptions()}
