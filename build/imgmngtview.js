(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["EditorImgModel"] = factory();
	else
		root["EditorImgModel"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/ui/imgmngtview.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*#__PURE__*/
function (_Component) {
  _inherits(FuncUploadModal, _Component);

  function FuncUploadModal(props) {
    var _this;

    _classCallCheck(this, FuncUploadModal);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FuncUploadModal).call(this, props));
    _this.table = _this.context;
    _this.id = Math.floor(Math.random() * 10000);
    _this.state = {
      files: [],
      directories: {},
      pwd: lang(_this.table[STRUCT_TABLE][DATA_TABLE_ID]),
      selects: {}
    };
    _this.selects = {};
    _this.page = 1;
  ...
  _createClass(FuncUploadModal, [{
    ...
    key: "refreshFile",
    value: function refreshFile() {
      var _this3 = this;

      App.loading(true, 'Refresh...');
      axios.request({
        url: '/uploader/uploader_disks/refresh',
        method: 'post'
      }).then(function (response) {
    ...
    value: function deleteFile(file) {
      ...
      return axios.request({
        ...
        if (response['result']) {
          delete _this4.selects[file[UP_MNGT_PATH]];
        } else {
          Swal(response['message'], response['data'], 'error');
        }
      })["catch"](function (error) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                files = this.state.selects;
                _context2.t0 = regeneratorRuntime.keys(files);
              ...
              case 2:
                ...
                _context2.next = 6;
                return this.readFile(files[i][UP_MNGT_PATH]);
    ...
    value: function render() {
      ...
      var _loop = function _loop(i) {
        fileName = _this5.state.files[i][UP_MNGT_PATH].replace(/^.*[\\\/]/, '');
        files.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          title: _this5.state.files[i][UP_MNGT_PATH],
          className: "file_item",
          key: i
          ...
          checked: isset(_this5.state.selects[_this5.state.files[i][UP_MNGT_PATH]]) && _this5.state.selects[_this5.state.files[i][UP_MNGT_PATH]],
          onChange: function onChange(event) {
            if (event.target.checked) {
              _this5.selects[_this5.state.files[i][UP_MNGT_PATH]] = _this5.state.files[i];
            } else {
              delete _this5.selects[_this5.state.files[i][UP_MNGT_PATH]];
            }

            _this5.setState({
              selects: _this5.selects
            });
          },
      ...
      }, lang(this.state.pwd)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        className: "close",
        "data-dismiss": "modal"
      ...
      }, this.page == 1 ? '' : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "file_page button",
        onClick: function onClick() {
          return _this5.updatePage('down');
        }
      }, '<')), count(this.state.files) < this.number ? '' : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "file_page button",
        onClick: function onClick() {
          return _this5.updatePage('up');
        }
      }, '>'))))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        style: {
          marginRight: 0,
      ...
      }), "\xA0Delete"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "button",
      ...
      }), "\xA0Download"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "button",
        title: "Refresh",
        onClick: function onClick() {
          _this5.refreshFile();
      ...
      }), "\xA0Refresh"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "file_container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Style, {
        id: "file_manager_css"
      }, "\n\t\t\t\t\t\t\t\t\t\t.file_container {\n\t\t\t\t\t\t\t\t\t\t\tdisplay: flex;\n\t\t\t\t\t\t\t\t\t\t\tflex-wrap: wrap;\n\t\t\t\t\t\t\t\t\t\t\tmargin-top: 15px;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t\t.file_item {\n\t\t\t\t\t\t\t\t\t\t    border-radius: 5px;\n\t\t\t\t\t\t\t\t\t\t    padding: 5px;\n\t\t\t\t\t\t\t\t\t\t    text-align: center;\n\t\t\t\t\t\t\t\t\t\t    width: 100px;\n\t\t\t\t\t\t\t\t\t\t    align-items: center;\n\t\t\t\t\t\t\t\t\t\t    overflow: hidden;\n\t\t\t\t\t\t\t\t\t\t    margin: 4px;\n\t\t\t\t\t\t\t\t\t\t\tposition: relative;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t\t.file_name {\n\t\t\t\t\t\t\t\t\t\t\twidth: 100%;\n\t\t\t\t\t\t\t\t\t\t\tfont-size: small;\n\t\t\t\t\t\t\t\t\t\t\tmargin-top: 5px;\n\t\t\t\t\t\t\t\t\t\t\tcolor: #607D8B;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t\t.file_icon {\n\t\t\t\t\t\t\t\t\t\t\tpadding: 5px;\n\t\t\t\t\t\t\t\t    \t\tborder-radius: 4px;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t\t.file_icon i{\n\t\t\t\t\t\t\t\t\t\t\tfont-size: 50px;\n\t\t\t\t\t\t\t\t\t\t\tcolor: #607D8B;\n\t\t\t\t\t\t\t\t\t\t\t-webkit-text-stroke: 1px white;\n\t\t\t\t\t\t\t\t\t\t\tcursor: pointer;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t\t.file_name:hover {\n\t\t\t\t\t\t\t\t\t\t    overflow: auto;\n\t\t\t\t\t\t\t\t\t\t    text-overflow: unset;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t\t.file_select {\n\t\t\t\t\t\t\t\t\t\t\tdisplay:none;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t\t.file_page {\n\t\t\t\t\t\t\t\t\t\t\tline-height: 1.25;\n\t\t\t\t\t\t\t\t\t\t    color: #607d8b;\n\t\t\t\t\t\t\t\t\t\t    background-color: #fff;\n\t\t\t\t\t\t\t\t\t\t    border: 1px solid #dee2e6;\n\t\t\t\t\t\t\t\t\t\t    padding: 5px 10px;\n\t\t\t\t\t\t\t\t\t\t    border-radius: 4px;\n\t\t\t\t\t\t\t\t\t\t    margin: 2px;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t\t.file_select:checked ~ .file_icon {\n\t\t\t\t\t\t\t\t\t\t    background: #e5e5e5;\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t"), files), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "modal-footer"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        className: "btn btn-primary",
        onClick: function onClick() {
          _this5.onSelect(_this5.state.selects[Object.keys(_this5.state.selects)[0]]);
        }
      }, lang('Select')), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
  ...
  return FuncUploadModal;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]);

Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["render"])(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FuncUploadModal, null), document.getElementById('editor'));

/***/ })

/******/ })["default"];
});
//# sourceMappingURL=imgmngtview.js.map